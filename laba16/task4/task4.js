...
function addProduct() {
    ...
    products.forEach(object => {
        const { id, title, description, price, discountPercentage, rating, stock, brand, category, thumbnail } = object;
        ...
        discountBlock.innerHTML = discountPercentage + "%";
        ...
        img.style = `object-fit:cover; overflow:hidden; width:200px; height:90px; background-image: url('${thumbnail}'); background-size: cover; background-position: center;`;
        ...
        idBlock.innerHTML = "🛒";
        idBlock.style = 'border:0px; background-color:white; cursor:pointer; font-size:20px;'
